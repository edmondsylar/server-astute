<div id="editlicence<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    <div class="modal-content white">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input placeholder="....." id="name" name="edit-term" type="text" required="required" value="<?php echo $record->intelligence_name; ?>">
