<div id="add-dateofbirth" class="modal modal" style="width: 400px;">
    <?php
    ...
    <div class="modal-header" style="margin-left: 10px">
        <span class="grey-text text-darken-4">New Date of Birth</span> </br>
        <!--<span class="grey-text ultra-small">Fields with <span class="red-text">*</span> are required</span>-->
    </div>
    <div class="modal-content white">
        <div class="row s12">
                <div class="input-field col s12">
                    <input placeholder="....." id="label" name="dateofbirth" type="text" class="masked" data-inputmask="'mask': 'y/m/d'">
