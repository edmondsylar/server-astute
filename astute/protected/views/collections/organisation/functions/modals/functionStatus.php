<div id="function-status<?php echo $record->id; ?>" class="modal" style="width: 400px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="function-id" value="<?php echo $record->id; ?>">
    <input  type="hidden" name="function-status" value="<?php echo $record->status; ?>">
    <div class="modal-content white" style="height: 115px;">
        <div class="modal-header">
            ...
            <span class="black-text">Change Function Status</span>
        </div>
