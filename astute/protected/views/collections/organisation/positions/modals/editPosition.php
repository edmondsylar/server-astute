<div id="editposition<?php echo $record->id; ?>" class="modal" style="width: 400px;">
    <?php
    ...
    <div class="modal-content white">
        <span class="grey-text text-darken-4">Edit Position Name</span> </br>
        <!--<span class="grey-text ultra-small">Field Marked with <span class="red-text">*</span> is required</span>-->
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <label for="name" class="active">Position Name</label>
                    </div>  
                </div>
    </div>
