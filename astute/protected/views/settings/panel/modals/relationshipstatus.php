<div id="relationshipstatus<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="relationship-id" value="<?php echo $record->id; ?>">
    <input  type="hidden" name="relationship-status" value="<?php echo $record->status; ?>">
