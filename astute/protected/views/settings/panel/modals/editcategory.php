<div id="editcategory<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    ...
    <div class="modal-content white">
        <span class="grey-text text-darken-4">Edit Intelligence Category</span> </br>
        <!--<span class="grey-text ultra-small">Field Marked with <span class="red-text">*</span> is required</span>-->
        <div class="row">
            <div class="input-field col s12">
                <input placeholder="....." id="name" name="new_category_name" type="text" required="required" value="<?php echo $record->name; ?>">
