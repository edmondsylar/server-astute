<div id="addressType-status<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="addresstype-id" value="<?php echo $record->id; ?>">
    <input  type="hidden" name="addresstype-status" value="<?php echo $record->status; ?>">
