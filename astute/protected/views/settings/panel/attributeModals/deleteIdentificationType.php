<div id="deleteidentificationType<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="identificationtype_delete_id" value="<?php echo $record->id; ?>">
