<div id="identificationtype-status<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="identificationtype-id" value="<?php echo $record->id; ?>">
    <input  type="hidden" name="identificationtype-status" value="<?php echo $record->status; ?>">
    <div class="modal-content white" style="height: 115px;">
        <div class="modal-header">
            ...
            <span class="black-text">Change Type Status</span>
        </div>
