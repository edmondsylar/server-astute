...
/**
 * This is the model class for table "t_functions".
 *
 * The followings are the available columns in table 't_functions':
 * @property integer $id
 ...
 */
class TFunctions extends CActiveRecord
{
	/**
	 ...
	 * @return TFunctions the static model class
	 */
