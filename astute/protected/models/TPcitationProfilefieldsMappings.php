...
/**
 * This is the model class for table "t_pcitation_profilefields_mappings".
 *
 * The followings are the available columns in table 't_pcitation_profilefields_mappings':
 * @property integer $id
 * @property integer $citation
 * @property integer $profilefield
 ...
 */
class TPcitationProfilefieldsMappings extends CActiveRecord
{
	/**
	...
	{
		return 't_pcitation_profilefields_mappings';
	}
	...
	public function rules()
	{
		...
		return array(
			array('maker', 'required'),
			array('citation, profilefield', 'numerical', 'integerOnly'=>true),
			...
			array('id, citation, profilefield, status, maker, data_entrant, rejectedreason_dataEntry, discard_reason_researcher', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('profilefield',$this->profilefield);
	 ...
	 * @return TPcitationProfilefieldsMappings the static model class
	 */
