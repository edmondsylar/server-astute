...
/**
 * This is the model class for table "t_organisationfunctions".
 *
 * The followings are the available columns in table 't_organisationfunctions':
 * @property integer $id
 ...
 */
class TOrganisationfunctions extends CActiveRecord
{
	/**
	...
	{
		return 't_organisationfunctions';
	}
	...
	public function rules()
	{
		...
		return array(
			array('organization, function, maker', 'required'),
			array('organization, function', 'numerical', 'integerOnly'=>true),
			...
			array('id, organization, function, start_date, end_date, createdon, maker, supervisor, status, supervisor_reject_reason, dataEntrant_discard_reason', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TOrganisationfunctions the static model class
	 */
