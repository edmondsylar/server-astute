...
/**
 * CFormElementCollection implements the collections for storing form elements.
 *
 * Because CFormElementCollection extends from {@link CMap}, it can be used like an associative array.
 * For example,
 * <pre>
 * $element=$collections['username'];
 * $collections['username']=array('type'=>'text', 'maxlength'=>128);
 * $collections['password']=new CFormInputElement(array('type'=>'password'),$form);
...
class CFormElementCollection extends CMap
{
	...
	/**
	 * Constructor.
	 * @param CForm $form the form object that owns this collections
	 * @param boolean $forButtons whether this collections is used to store buttons.
	 */
	 ...
	 * can be stored in this collections.
	 * @param mixed $key key
	 ...
	 * @param string $key the name of the element to be removed from the collections
	 * @throws CException
	 */
