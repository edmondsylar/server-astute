 ...
 * {@link elements} collections, it is called a sub-form which can have its own {@link elements}
...
class CForm extends CFormElement implements ArrayAccess
{
	...
	/**
	 * This method is called after an element is added to the element collections.
	 * @param string $name the name of the element
	 * @param CFormElement $element the element that is added
	 * @param boolean $forButtons whether the element is added to the {@link buttons} collections.
	 * If false, it means the element is added to the {@link elements} collections.
	 */
	...
	/**
	 * This method is called after an element is removed from the element collections.
	 * @param string $name the name of the element
	 * @param CFormElement $element the element that is removed
	 * @param boolean $forButtons whether the element is removed from the {@link buttons} collections
	 * If false, it means the element is removed from the {@link elements} collections.
	 */
