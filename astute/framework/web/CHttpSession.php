 ...
 * @property float $gCProbability The probability (percentage) that the gc (garbage collections) process is started on every session initialization, defaults to 1 meaning 1% chance.
...
class CHttpSession extends CApplicationComponent implements IteratorAggregate,ArrayAccess,Countable
{
	...
	/**
	 * @return float the probability (percentage) that the gc (garbage collections) process is started on every session initialization, defaults to 1 meaning 1% chance.
	 */
	...
	/**
	 * @param float $value the probability (percentage) that the gc (garbage collections) process is started on every session initialization.
	...
	/**
	 * Session GC (garbage collections) handler.
	 * This method should be overridden if {@link useCustomStorage} is set true.
	 * Do not call this method directly.
