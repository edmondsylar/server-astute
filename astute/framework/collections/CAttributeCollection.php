<?php
/**
 * This file contains classes implementing attribute collections feature.
 *
...
/**
 * CAttributeCollection implements a collections for storing attribute names and values.
 *
 ...
 * <pre>
 * $collections->text='text'; // same as:  $collections->add('text','text');
 * echo $collections->text;   // same as:  echo $collections->itemAt('text');
 * </pre>
 *
 * The case sensitivity of attribute names can be toggled by setting the
 * {@link caseSensitive} property of the collections.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CAttributeCollection extends CMap
{
	 ...
	 * a key value if the key exists in the collections.
	 ...
	 * if the key exists in the collections and contains a non-null value.
	 * @param string $name the property name or the event name
	 ...
	 * if the collections contains the named key.
	 ...
	 * because you can always add a new value to the collections.
	 * @param string $name the property name
	 * @return boolean true
	 */
