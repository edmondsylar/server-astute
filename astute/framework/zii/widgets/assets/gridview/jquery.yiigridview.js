...
(function ($) {
	...
	methods = {
		...
		/**
		 * Returns the jQuery collections of the cells in the specified row.
		 * @param row integer the row number (zero-based index)
		 * @return jQuery the jQuery collections of the cells in the specified row.
		 */
		getRow: function (row) {
		...
		/**
		 * Returns the jQuery collections of the cells in the specified column.
		 * @param column integer the column number (zero-based index)
		 * @return jQuery the jQuery collections of the cells in the specified column.
		 */
