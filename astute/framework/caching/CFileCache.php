 ...
 * CFileCache will perform garbage collections automatically to remove expired cache files.
 *
 * See {@link CCache} manual for common cache operations that are supported by CFileCache.
 *
 * @property integer $gCProbability The probability (parts per million) that garbage collections (GC) should be performed
...
class CFileCache extends CCache
{
	...
	/**
	 * @return integer the probability (parts per million) that garbage collections (GC) should be performed
	 * when storing a piece of data in the cache. Defaults to 100, meaning 0.01% chance.
	 */
	...
	/**
	 * @param integer $value the probability (parts per million) that garbage collections (GC) should be performed
	 * when storing a piece of data in the cache. Defaults to 100, meaning 0.01% chance.
